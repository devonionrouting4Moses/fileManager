...
**PATCH Updates** (e.g., v2.0.0 → v2.0.0)
```
🔧 PATCH UPDATE AVAILABLE: v2.0.0 → v2.0.0
─ Security & Bug Fixes ─
...
**MINOR Updates** (e.g., v2.0.0 → v2.0.0)
```
════════════════════════════════════════════════════════════
║ ✨ NEW FEATURES AVAILABLE: v2.0.0 → v2.0.0
║ ────────────────────────────────────────────────────────
...
**MAJOR Updates** (e.g., v2.0.0 → v2.0.0)
```
══════════════════════════════════════════════════════════════════
