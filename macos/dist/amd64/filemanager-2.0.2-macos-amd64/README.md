...
wget https://github.com/DevChigarlicMoses/FileManager/releases/download/v2.0.2/filemanager_0.1.2_amd64.deb
...
wget https://github.com/DevChigarlicMoses/FileManager/releases/download/v2.0.2/filemanager_0.1.3_amd64.deb
sudo dpkg -i filemanager_0.1.3_amd64.deb
```

### Update Notifications

**PATCH Updates** (e.g., v2.0.2 → v2.0.2)
```
🔧 PATCH UPDATE AVAILABLE: v2.0.2 → v2.0.2
─ Security & Bug Fixes ─
...
**MINOR Updates** (e.g., v2.0.2 → v2.0.2)
```
════════════════════════════════════════════════════════════
║ ✨ NEW FEATURES AVAILABLE: v2.0.2 → v2.0.2
║ ────────────────────────────────────────────────────────
...
**MAJOR Updates** (e.g., v2.0.2 → v2.0.2)
```
══════════════════════════════════════════════════════════════════
...
- **v2.0.2** - Current version (dual-mode with web interface)
